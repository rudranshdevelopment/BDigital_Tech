/**
 * BDigital Tech - Global Configuration & Content Data
 * Single source of truth for services, WhatsApp routing, and copy.
 */

window.SITE_CONFIG = {
  // WhatsApp Configuration - Change this number to route to client's WhatsApp (country code + number, no '+' or spaces)
  ...
  // All 19 Services with Verbatim Appendix Copy & Custom Visual Metaphors
  services: [
    {
      id: "crm",
      number: "01",
  ...
  // Industries We Serve
  industries: [
    { name: "Healthcare & Clinics", tag: "EHR & Appointments", icon: "pulse", desc: "HIPAA-compliant patient portals, doctor scheduling, and unified lab billing systems." },
    { name: "Real Estate & PropTech", tag: "Deals & Inventory", icon: "building", desc: "Dynamic unit visualizers, broker commission pipelines, and lead-to-site visit workflows." },
    { name: "Restaurant & Hospitality", tag: "POS & KDS", icon: "utensils", desc: "Lightning POS, contactless tableside ordering, kitchen display workflows, and recipe costing." },
    { name: "Salon & Luxury Spas", tag: "Chair & Roster", icon: "sparkles", desc: "Stylist appointment allocation, retail packages, formula history, and automated recall SMS." },
    { name: "Logistics & Supply Chain", tag: "Fleet & ePOD", icon: "truck", desc: "Real-time GPS telematics, automated dispatch routing, and digital proof-of-delivery." },
    { name: "Retail & E-Commerce", tag: "Storefront & Cart", icon: "shopping-bag", desc: "High-speed headless commerce engines, multi-warehouse sync, and flash-sale scale." },
    { name: "Financial Services", tag: "Ledger & Compliance", icon: "chart-line", desc: "Encrypted transaction ledgers, automated bank reconciliation, and statutory audit logging." },
    { name: "Enterprise SaaS & B2B", tag: "Multi-Tenant Cloud", icon: "cloud", desc: "Scalable multi-tenant SaaS architecture, metered usage billing, and customer portals." }
  ],

  // Helper method to get WhatsApp Link
  getWhatsAppUrl: function(customText) {
    var text = customText || this.defaultMessage;
